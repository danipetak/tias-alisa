...
class AdjustmentPeriodeBerjalan extends Controller
{
    ...
    public function index()
    {
        ...
        return view('page.transaksi.adjustment_berjalan.index', compact('aruskas'));
    }

    public function riwayat()
    {
        $riwayat    =   Header::list_trans(['AJB']);
    ...
    public function store(Request $request)
    {
        ...
        $trans->reff                =   $parent ? 'CJ' : 'AJB';
        $trans->nomor               =   Header::nomor_transaksi($parent ? 'CJ' : 'AJB');
